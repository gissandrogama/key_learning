...
{:ok, otp} =
  KeyLearning.School.create_course(%{
    name: "OTP",
    image_path:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJ_vopfFWAjzLRAoV12qb8WZaGGer5GGxJeA&usqp=CAU"
  })
